 ...
 * var jsdocParser = new (require('jsdoc/src/rhinoParser').Parser)();
 */
    ...
    for (var i = 0, leni = sourceFiles.length; i < leni; i++) {
        if (sourceFiles[i].indexOf(SCHEMA) === 0) {
            ...
            try {
                ...
                console.log('FILE READ ERROR: in module:jsdoc/src/rhinoParser.parseFiles: "' + filename + '" ' + e);
                continue;
            }
        }
...
/** @private
    @memberof module:jsdoc/src/rhinoParser.Parser
*/
